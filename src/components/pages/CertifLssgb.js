...
import Lssgb from '../../assets/images/LssGB.jpg'
import SmallTrainingCards from '../inc/SmallTrainingCards';

export default function CertifLssgb() {
    return (
                        ...
                        <div className="row">
                            <div className="col-md-6 text-center">
                                <div className="col-md-6 text-left">
                                    <img src={Lssgb} className="w-50 border-bottom" alt="Formación Lean Six Sigma Green Belt" />
                                </div>
